sockjs-protocol-tests:
	...
	./venv/bin/python sockjs-protocol/sockjs-protocol-0.3.3.py Http10.test_synchronous	
	# ./venv/bin/python sockjs-protocol/sockjs-protocol-0.3.3.py Http10.test_streaming
